...
import Shipemnt from "./component/shipemnt"
...
{shipmetnTab?<Shipemnt/>:<Inventory editInventory={editInventory} getInventory={getInventory}  openInventory={openInventory} inventory={inventory}/>}

</div>
    </div>

{editBox?<Edit  curentProduct={curentProduct} getInventory={getInventory} openInventory={openEdit}/>:''}
{addInventory?<AddIntentory  getInventory={getInventory} openInventory={openInventory}/>:""}
    </div>
