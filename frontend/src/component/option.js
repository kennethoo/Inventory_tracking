...
class Option extends Component{
    ...
    deleteIventory=()=>{
        ...
        axios.post("http://localhost:4000/removeinventory",inventory).then((result)=>{
...
this.props.editInventory(this.props.id)
  ...
  return(
    ...
    <div className="title-of--thise-action">    
        <button  onClick={()=>{this.props.setOpen(true)}}   className="close-that"><IoEllipsisVertical/></button>
  </div>
      ...
      <div   className="box-that-hold-the-setting">
             ...
             <MdModeEditOutline/>
                ...
                <button  onClick={this.updateInventory}  className="edit-the-program">Edit</button>
                </div>
           <div   className="box-that-hold-the-setting">
                <div className="hold-thatiocom">
             <MdDelete/>
